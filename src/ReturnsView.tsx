...
export function ReturnsView({ userId, categories, records, entries, loading }: ReturnsViewProps) {
  ...
  // No net-of-dividends figure here. Flows are grouped by date and summed before
  // any of this, so a dividend landing on a day money also went in has already
  // come off that day's contribution. Subtracting the dividend total again took
  // most of them off twice.
